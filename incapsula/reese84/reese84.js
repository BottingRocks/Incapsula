...
class Reese84 {
  ...
  decodePayload(data, xor, dropUniqueKey=true){
    ...
    if(this.signalKeys.canvas_hash.canvas_hash.value in rawDecodedPayload){
      ...
      if(rawPayload[this.signalKeys.canvas_hash.to_data_url_image_error.value]){
    ...
    if(this.signalKeys.webgl_rendering_call.webgl_rendering_call.value in rawDecodedPayload){
      ...
      const rawPayload = decode(this.encoders[6][5].decoder, rawDecodedPayload[this.signalKeys.webgl_rendering_call.webgl_rendering_call.value], `webgl_rendering_Call`);
