    ...
    const encodedPayload = encode(this.encoders[10][0].encoder, {
      ...
      [this.signalKeys[`browser`]] : encode(this.encoders[7][3].encoder, {
        ...
        [isChrome ? this.signalKeys[`browser.chrome`] : undefined] : isChrome ? {
          ...
          [this.signalKeys[`browser.chrome.chrome`]] : data.browser.chrome.chrome
        } : undefined,
  ...
  decodePayload(data, xor) {
    ...
    if (this.signalKeys[`browser`] in rawDecodedPayload) {
      ...
      if (chrome in rawPayload) {
        ...
        decodedPayload[`browser`][`chrome`][`chrome`] = rawPayload[chrome][this.signalKeys[`browser.chrome.chrome`]];
      }
    ...
    if(rawDecodedPayload[this.signalKeys[`performance_difference`]] === undefined){
      ...
      decodedPayload[`performance_difference`][`dump_a`] = rawPayload[this.signalKeys[`performance_difference.dump_a`]];
